...
echo('<td width="20px" align="center" bgcolor="99cc33"><font face="Arial" size="1">Fun&ccedil;&atilde;o</font></td>');
...
echo('<td width="150px" align="center" bgcolor="99cc33"><font face="Arial" size="1">Salario</font></td></tr>');
...
echo("<td align=\"center\"><a href=\"pr_alterar_funcionario.php?id=$row0&Nome=$row1&Sobrenome=$row8&Sexo=$row2&Data=$row3&Fun=$row4&telefone=$row5&email=$row6&Morada=$row7&Salario=$row9\">$row1</a></td>");
