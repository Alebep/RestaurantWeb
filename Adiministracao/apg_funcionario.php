...
echo("<td align=\"center\"><a href=\"processar_apg_funcionario.php?id=$row0&Nome=$row1&Sobrenome=$row8&Sexo=$row2&Data=$row3&Fun=$row5&telefone=$row6&email=$row7&Morada=$row8&Salario=$row9\">$row1</a></td>");
